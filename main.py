...
#ingresa un número impar. Usa un ciclo 
#while para lograr esto
...
while True:
    print(f"""\nHello Mrs/Ms {name} this is a program for calculate the sum of even numbers \n""")
    try:
        num=0
        a = 0
        while True:
